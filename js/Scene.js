var Scene = function(gl, output) {
  ...
  this.rightThrust = new Vec3(this.thrustForce, 0,0);
  this.leftThrust = new Vec3(-this.thrustForce, 0,0);
  this.upThrust = new Vec3(0,this.thrustForce, 0);
  this.forceOfGravity = new Vec3(0,-75,0);
